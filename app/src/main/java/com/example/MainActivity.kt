...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        // Fix 7: Android 12+ splash (navy + launcher icon)
        installSplashScreen()
        super.onCreate(savedInstanceState)

        // Fix 3: remote debugging on debug builds only
        WebView.setWebContentsDebuggingEnabled(BuildConfig.DEBUG)

        enableEdgeToEdge()

        // Fix 7: explicit system bar colors (#0F172A) for OEM consistency
...
fun MainScreen() {
    ...
    DisposableEffect(lifecycleOwner, webView) {
        val observer = LifecycleEventObserver { _, event ->
            ...
            // Soft sync only — never hard-reload on resume (Fix 2).
                ...
                Column(
                    ...
                    Row(
                        ...
                        Row(
                            ...
                            BrandMark(size = 34.dp, corner = 8.dp)
                ...
                NavigationBar(
                    ...
                    items.forEachIndexed { index, item ->
                        NavigationBarItem(
                            ...
                            onClick = {
                                // Fix 8: haptic on tab tap
                                view.performHapticFeedback(HapticFeedbackConstants.CONTEXT_CLICK)
                                // Fix 6: already on this tab → do not reload
                ...
                AndroidView(
                    factory = { ctx ->
                        WebView(ctx).apply {
                            ...
                            // Fix 5: native-feel scroll chrome
                            ...
                            settings.apply {
                                ...
                                // Fix 1: leave default UA untouched (no custom tokens)
                            }
                            webViewClient = object : WebViewClient() {
                                ...
                                override fun onPageStarted(view: WebView?, url: String?, favicon: android.graphics.Bitmap?) {
                                    pageLoading = true
                                    // Fix 4: full hide CSS as early as possible (before first paint)
                                ...
                                override fun onPageFinished(view: WebView?, url: String?) {
                                    ...
                                    // Re-apply after DOM is fully ready (SPA navigations / late headers)
                                    view?.evaluateJavascript(NATIVE_CHROME_JS, null)
                                }
