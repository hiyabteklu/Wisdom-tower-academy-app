...
fun MainScreen() {
    ...
    DisposableEffect(lifecycleOwner, webView) {
        val observer = LifecycleEventObserver { _, event ->
            ...
            // Soft sync only — never hard-reload on resume.
            // Hard reload mid-challenge resets bot verification and causes Code 705 loops.
                    ...
                    factory = { ctx ->
                        WebView(ctx).apply {
                            ...
                            settings.apply {
                                ...
                                // Do NOT mutate userAgentString — custom tokens trigger bot challenges (Code 705).
                                // App detection (if needed later) should use a custom header, not UA mutation.
                            }
                                ...
                                override fun onPageFinished(view: WebView?, url: String?) {
                                    ...
                                    val js =
                                        "(function(){try{" +
                                            ...
                                            "s.textContent='header,[data-site-header],footer,[data-site-footer],.site-header,.site-footer{display:none!important;}'+" +
